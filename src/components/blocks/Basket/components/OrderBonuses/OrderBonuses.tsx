...
const OrderBonuses = () => {
  ...
  return (
    <div className={styles.bonuses}>
      ...
      {isPromoOpen && (
        <div
          className={`${styles.bonuses__promo} ${isPromoOpen ? styles.bonuses__promo_active : ""}`}
        >
          <input
            type="text"
            placeholder={"Промокод"}
            className={styles.bonuses__promo_input}
          />
          <button className={styles.bonuses__promo_button}>Ок</button>
        </div>
      )}
    </div>
  );
