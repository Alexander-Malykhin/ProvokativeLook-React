...
// components
import ContactMap from "@components/blocks/ContactUs/components/ContactMap/ContactMap.tsx";
import ContactUsSkeleton from "@components/blocks/ContactUs/components/ContactUsSkeleton/ContactUsSkeleton.tsx";
// api
      ...
      <MainLayoutContainer className={styles.contacts}>
        <div className={styles.contacts__column}>
          <div className={styles.contacts__row}>
            <span className={styles.contacts__label}>Телефон:</span>
          ...
          <div className={styles.contacts__row}>
            <span className={styles.contacts__label}>Электронная почта:</span>
          ...
          <div className={styles.contacts__row}>
            <span className={styles.contacts__label}>Фактический адрес:</span>

            <p className={styles.contacts__text}>{data.address}</p>
          </div>
